...
public class ArrayListEx {
	...
	public static void main(String[] args) {
		...
		System.out.println("세번재 아이템 : " + item);
		
		//요소 확인
		boolean hasMacBook = new shoppingCart.contains("삼성 갤럭시북");
		...
		System.out.println("가지고 싶은 5가지 물건 입력하기");
